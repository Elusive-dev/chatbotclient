<template>
  <section class="pt-10  bg-gray-100 sm:pt-16 lg:pt-24">
    <div class="px-4 min-h-[75vh] mx-auto sm:px-6 lg:px-8 max-w-7xl">
      <div class="max-w-2xl mx-auto text-center">
        ...
        <p class="mt-6 text-lg text-gray-900">
          Project Defence <br> Matric No: XXXXXXXXXX
        </p>
        <p>Welcome to our Smart Document Chatbot, designed to make your document creation process faster, easier, and more efficient than ever before. Whether you're drafting a business proposal, writing a research paper, or composing a heartfelt letter, our intelligent chatbot is here to assist you every step of the way.</p>
        <q-btn
         :to="{path: '/chatbot'}"
